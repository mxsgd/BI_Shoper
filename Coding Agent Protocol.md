...
- Write them in a highly reusable fashion, so you don't have to prepare a test case for every scenario you're testing
- Tests are always located a __tests__ directory at the same level as the file you're testing
- Test files always end with .test.ts
